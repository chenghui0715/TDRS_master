...
namespace YH.ICMS.Common
{
    ...
    public class ROW_BASE
    {
        ...
        //public static ROW_BASE Create(String sFullTypeName, DataRow row, DataColumnCollection columns)
        //{
        //    if (row == null || columns == null) return null;
        //    ROW_BASE baseclass = null;
        //    try
        //    {
        //        //baseclass = (ROW_BASE)typeof(ROW_BASE).Assembly.CreateInstance(sFullTypeName);
        //        Assembly asm = Assembly.LoadFrom("TOSInterface_SHB.dll");
        //        baseclass = (ROW_BASE)asm.CreateInstance(sFullTypeName);
        ...
        //                    {
        //                        Object obj = null;
        //                        String sObj = row[column].ToString();
        //                        if (!String.IsNullOrEmpty(sObj))
        //                        {
        //                            if (!mType.IsEnum)
        //                                obj = Convert.ChangeType(sObj, mType);
        //                            else
        //                                obj = Enum.Parse(mType, sObj);
        //                        }
        //                        //mType
        //                        // Type t = mis[0].FieldType.GetType();
        ...
        //public static ROW_BASE Create(String sNameSpace, String sClassName, DataRow row, DataColumnCollection columns)
        //{
        //    String sFullTypeName = sNameSpace + "." + sClassName;
        //    return ROW_BASE.Create(sFullTypeName, row, columns);
        //}
        ...
        public static object ChangeType(object value, Type conversionType)
        {
            ...
            //    string s = System.Convert.ToString(value);
            //    if (string.IsNullOrWhiteSpace(s)) s = "0";
            //    return Convert.ChangeType(s, conversionType);
            //}
        ...
        //        System.Reflection.MemberInfo[] aryMI = this.GetType().GetMembers();
        //        foreach (System.Reflection.MemberInfo mi in aryMI)
        //        {
        ...
        //            try
        //            {
        //                Object obj = this.GetType().InvokeMember(mi.Name, System.Reflection.BindingFlags.GetField, null, this, null);
        //                if (obj != null)
        //                    ht[mi.Name] = obj;
        //            }
        //            catch { }
